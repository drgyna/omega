...
Fecha de registro: 2029-08-14
Clasificación de datos: Uso interno — datos sintéticos de prueba

Permiso controlado: Permiso de operación turística
Autoridad o emisor: Autoridad marítima competente — registro ficticio
Número de control: PERM-GUE-00540
Fecha de emisión: 2028-11-07
Fecha de vencimiento: 2029-11-07
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Emilio Rivas Solís
Riesgo de vencimiento: Medio

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Azimut 55 Flybridge en Ixtapa-Zihuatanejo. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
