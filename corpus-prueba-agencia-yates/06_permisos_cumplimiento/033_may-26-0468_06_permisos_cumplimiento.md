...
Número de control: PERM-VER-00567
Fecha de emisión: 2029-01-27
Fecha de vencimiento: 2030-01-27
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Paola Serrano Nieto
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Jeanneau DB/43 en Veracruz. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
