...
Número de control: PERM-BAJ-00569
Fecha de emisión: 2029-02-02
Fecha de vencimiento: 2030-02-02
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Renata Villaseñor Díaz
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Pershing 5X en La Paz. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
