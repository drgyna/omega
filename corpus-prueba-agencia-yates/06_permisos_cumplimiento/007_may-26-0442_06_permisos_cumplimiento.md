...
Fecha de registro: 2029-08-17
Clasificación de datos: Uso interno — datos sintéticos de prueba

Permiso controlado: Registro de equipo de seguridad
Autoridad o emisor: Autoridad marítima competente — registro ficticio
Número de control: PERM-BAJ-00541
Fecha de emisión: 2028-11-10
Fecha de vencimiento: 2029-11-10
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Elena Quintana Ríos
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Sunseeker Manhattan 66 en Ensenada. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
