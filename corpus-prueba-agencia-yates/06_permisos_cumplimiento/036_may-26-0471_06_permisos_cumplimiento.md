...
Número de control: PERM-JAL-00570
Fecha de emisión: 2029-02-05
Fecha de vencimiento: 2030-02-05
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Andrés Ledesma Vela
Riesgo de vencimiento: Medio

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Azimut 55 Flybridge en Puerto Vallarta. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
