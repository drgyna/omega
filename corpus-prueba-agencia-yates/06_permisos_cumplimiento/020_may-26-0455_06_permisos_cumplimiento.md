...
Fecha de registro: 2029-09-25
Clasificación de datos: Uso interno — datos sintéticos de prueba

Permiso controlado: Póliza de responsabilidad civil
Autoridad o emisor: Autoridad marítima competente — registro ficticio
Número de control: PERM-OAX-00554
Fecha de emisión: 2028-12-19
Fecha de vencimiento: 2029-12-19
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Diego Salvatierra Ponce
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Lagoon 46 en Huatulco. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
