...
Número de control: PERM-QUI-00548
Fecha de emisión: 2028-12-01
Fecha de vencimiento: 2029-12-01
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Mateo Cárdenas Ruiz
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Fountaine Pajot Isla 40 en Playa del Carmen. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
