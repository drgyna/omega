...
Número de control: PERM-VER-00543
Fecha de emisión: 2028-11-16
Fecha de vencimiento: 2029-11-16
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Luciana Figueroa Arias
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Beneteau Oceanis 46.1 en Veracruz. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
