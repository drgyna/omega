...
Número de control: PERM-BAJ-00544
Fecha de emisión: 2028-11-19
Fecha de vencimiento: 2029-11-19
Titular registrado: Mar Azul Charter & Sales, S.A. de C.V.
Responsable de renovación: Nicolás Peralta Soto
Riesgo de vencimiento: Bajo

## Objeto de control

Este registro centraliza el seguimiento interno de permisos, pólizas, registros y autorizaciones relacionados con la operación de Lagoon 46 en Cabo San Lucas. El equipo de cumplimiento debe verificar la versión vigente directamente con el emisor y no asumir que este archivo sustituye un documento oficial. Las fechas se usan para activar recordatorios, solicitar evidencias y prevenir que se programe una salida sin soporte documental suficiente.
