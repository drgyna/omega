...
Ciudad base: Veracruz
Estado de operación: Veracruz
Marina: Marina Veramar
Zona de navegación: Golfo de México
Embarcación: Pershing 5X
Clase de embarcación: motor
Eslora: 54 pies
Capacidad autorizada: 10 pasajeros
Responsable interno: Mónica Trejo Navas
Fecha de registro: 2030-06-07
Clasificación de datos: Uso interno — datos sintéticos de prueba

Tipo de incidente: Lesión leve atendida a bordo
Fecha y hora del evento: 2030-06-11T12:15
Reportado por: Mónica Trejo Navas
Nivel de severidad: Bajo
Personas involucradas: Gabriel Pineda Cota y tripulación asignada
Embarcación afectada: Pershing 5X
Acción inmediata: Evaluación de seguridad y notificación al responsable de turno
Fecha objetivo de cierre: 2030-06-19

## Descripción objetiva

Durante una operación cercana a Veracruz, la tripulación identificó la situación descrita y aplicó el procedimiento inicial: reducir riesgo, informar a pasajeros de manera clara, verificar que no hubiera lesión o daño crítico y registrar hora, ubicación aproximada y decisiones tomadas. El capitán mantuvo la autoridad operativa y, cuando fue necesario, ajustó la ruta para regresar a un punto seguro. No se atribuyen responsabilidades definitivas en este reporte preliminar.
